    ...
    <section class="testimonials">
        ...
        <div class="container py-5">
            ...
            <header class="text-center mb-5">
              <h1 class="display-4 font-weight-bold">Kids' Top</h1>
            ...
            <div class="row pb-5 mb-4">
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                ...
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/KTop1.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <br/>
                    <h5 class="card-title p1">Rs Rs 2,490</h5>

                    <h5> <a href="http://127.0.0.1:8000/BSwimsuit" class="text-dark">Audrey Girls One-Piece Sleeve Swimsuit</a></h5>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/KTop2.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs 4,790</h5>

                    <h5> <a href="http://127.0.0.1:8000/LegSwimsuit" class="text-dark">Audrey Girls One-Piece Sleeve Leg Swimsuit</a></h5>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/KTop33.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <br/>
                    <h5 class="card-title p1">Rs 3,990</h5>

                    <h5> <a href="http://127.0.0.1:8000/Pswimsuit" class="text-dark">Audrey Sleeve girls swimsuit - pink</a></h5>
                    <p class="small text-muted font-italic">TARMAK</p>
                    <br/>
                    <ul class="list-inline small">
                        <span class="fa fa-star checked"></span>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/KTop4.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs 3,990</h5>

                    <h5> <a href="http://127.0.0.1:8000/Sswimsuit" class="text-dark">Leony Girls One-Piece Skirt Swimsuit - Pink</a></h5>
                    <p class="small text-muted font-italic">TARMAK</p>
                    <ul class="list-inline small">
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
