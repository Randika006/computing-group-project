            ...
            <div class="row pb-5 mb-4">
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                ...
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/Bball.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs 1,990</h5>

                    <h5> <a href="http://127.0.0.1:8000/OrangeBall" class="text-dark">R100 Adult Size 7 Durable Basketball Perfect for Beginners</a></h5>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/YBball.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs 1,990</h5>

                    <h5> <a href="http://127.0.0.1:8000/YellowBall" class="text-dark">R100 Size 5 Basketball - YellowPerfect for beginners. Durable</a></h5>
                    <p class="small text-muted font-italic">TARMAK</p>
                    <br/>
                    <ul class="list-inline small">
                        <span class="fa fa-star checked"></span>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/KBball.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs 990</h5>

                    <h5> <a href="http://127.0.0.1:8000/BlueBall" class="text-dark">Mini B Kids' Size 1 Basketball Up to age 4.Red/Blue</a></h5>
                    <p class="small text-muted font-italic">TARMAK</p>
                    <br/>
                    <ul class="list-inline small">
                        <span class="fa fa-star checked"></span>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/Kball.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs 990</h5>

                    <h5> <a href="http://127.0.0.1:8000/RedBall" class="text-dark">Mini B Kids' Size 1 Basketball Up to age 4.blue</a></h5>
                    <p class="small text-muted font-italic">TARMAK</p>
                    <br/>
                    <ul class="list-inline small">
                        <span class="fa fa-star checked"></span>
