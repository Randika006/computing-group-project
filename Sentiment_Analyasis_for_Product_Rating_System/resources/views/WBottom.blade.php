    ...
    <section class="testimonials">
        ...
        <div class="container py-5">
            ...
            <header class="text-center mb-5">
              <h1 class="display-4 font-weight-bold">Womens' Bottom</h1>
            ...
            <div class="row pb-5 mb-4">
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                ...
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/WFitness.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs Rs 7,490</h5>

                    <h5> <a href="http://127.0.0.1:8000/GLeggin" class="text-dark">Women's Cotton Gym Legging Salto - Black</a></h5>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/WFitness4.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs 4,790</h5>

                    <h5> <a href="http://127.0.0.1:8000/RunningShort" class="text-dark">RUN DRY WOMEN'S RUNNING SHORTS -Black</a></h5>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/WFitness2.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs 990</h5>

                    <h5> <a href="http://127.0.0.1:8000/HTrouser" class="text-dark">Womens' MH100 mountain hiking trousers- Dark Grey</a></h5>
                    <p class="small text-muted font-italic">TARMAK</p>
                    <br/>
                    <ul class="list-inline small">
                        <span class="fa fa-star checked"></span>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/WFitness3.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs 990</h5>

                    <h5> <a href="http://127.0.0.1:8000/WhiteShort" class="text-dark">RUN DRY WOMEN'S RUNNING SHORTS -White</a></h5>
                    <p class="small text-muted font-italic">TARMAK</p>
                    <br/>
                    <ul class="list-inline small">
                        <span class="fa fa-star checked"></span>
