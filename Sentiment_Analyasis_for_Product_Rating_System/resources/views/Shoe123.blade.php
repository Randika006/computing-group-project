...
<html lang="en">
  <head>
    <title>RUN CUSHION MEN'S RUNNING SHOES</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="/img/RShoe1.jpg" class="d-block w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="/img/RShoe2.jpg" class="d-block w-100" >
                      </div>
                      <div class="carousel-item">
                        <img src="img/RShoe3.jpg" class="d-block w-100" >
                      </div>
                    </div>
            ...
            <div class="col-md-7">
                ...
                <img src="/img/RShoe4.jpg" class="stars">
                <h2>DESCRIPTION</h2> <br><br>
                <p>Gender, MEN'S. TYPE OF SHOES, Cushioning.</p>
