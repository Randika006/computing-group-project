    ...
    <div class="container">
        <div class="row">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="/img/to1.jpg" class="d-block w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="/img/to2.jpg" class="d-block w-100" >
                      </div>
                      <div class="carousel-item">
                        <img src="/img/to3.jpg" class="d-block w-100" >
                      </div>
                    </div>
            ...
            <div class="col-md-7">
                ...
                <img src="/img/to1.jpg" class="stars">
                <h2>DESCRIPTION</h2> <br><br>
                <p>Our designers created these towels to dry yourself and get changed after a surfing session.</p>
