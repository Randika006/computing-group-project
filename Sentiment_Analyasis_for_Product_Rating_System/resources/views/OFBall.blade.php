    ...
    <div class="container">
        <div class="row">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="/img/OFBall1.jpg" class="d-block w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="/img/OFBall2.jpg" class="d-block w-100" >
                      </div>
                      <div class="carousel-item">
                        <img src="img/OFBall3.jpg" class="d-block w-100" >
                      </div>
                    </div>
            ...
            <div class="col-md-7">
                ...
                <h2>Orange Football</h2>
                <p>Product code:  xyz</p>
                <img src="/img/OFBall4.jpg" class="stars">
                <h2>DESCRIPTION</h2> <br><br>
                <p>Between 68.5 and 69.5g (Size 5) Between 63.5 and 66g (Size 4) Between 60.5 and 62.5g (Size 3)</p>
