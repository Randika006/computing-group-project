    ...
    <section class="testimonials">
        ...
        <div class="container py-5">
            ...
            <header class="text-center mb-5">
              <h1 class="display-4 font-weight-bold">Baseball</h1>
            ...
            <div class="row pb-5 mb-4">
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
               ...
               <div class="card-body p-4"><img src="/img/Baseball.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <br/><br/>
                    <h5 class="card-title p1">Rs 1,990</h5>

                    <h5> <a href="http://127.0.0.1:8000/WBall" class="text-dark">White Baseball</a></h5>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/Bhelmet.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs 1,990</h5>

                    <h5> <a href="http://127.0.0.1:8000/BHelmet" class="text-dark">Baseball helmet</a></h5>
                    <p class="small text-muted font-italic">TARMAK</p>
                    <ul class="list-inline small">
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <!-- Card-->
                <div class="card rounded shadow-sm border-0">
                  <div class="card-body p-4"><img src="/img/BBat.jpg" alt="" class="img-fluid d-block mx-auto mb-3">
                    <h5 class="card-title p1">Rs 990</h5>

                    <h5> <a href="http://127.0.0.1:8000/BBat" class="text-dark">Baseball Bat</a></h5>
                    <p class="small text-muted font-italic">TARMAK</p>
                    <ul class="list-inline small">
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
