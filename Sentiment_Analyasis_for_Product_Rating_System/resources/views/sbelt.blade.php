    ...
    <div class="container">
        <div class="row">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="/img/sanu3.jpg" class="d-block w-100">
                      </div>
                      <div class="carousel-item">
                        <img src="/img/sbelt2.jpg" class="d-block w-100" >
                      </div>
                      <div class="carousel-item">
                        <img src="img/sbelt1.jpg" class="d-block w-100" >
                      </div>
                    </div>
            ...
            <div class="col-md-7">
                ...
                <img src="/img/SanuBelt.png" class="stars">
                <h2>DESCRIPTION</h2> <br><br>
                <p>Complementary products:Sauna suit, sauna jacket, sauna shorts.</p>
