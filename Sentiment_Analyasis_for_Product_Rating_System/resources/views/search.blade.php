...
<p style="font-size:23pt;text-align:center;position:relative;left:-190px;"><b>Search Order Details</b></p>
    <div class="container">
        <div class="row">
               <div class="col-md-6" style="margin-top:40px">
                  ...
                  <form action="/search"  method="GET">
                       <div class="form-group"> 
                         ...
                         <input type="text" name="payer_email" id="" class="form-control" placeholder="Enter mail address..."  style="height:60px;width:788px;font-size:18pt;">
                       </div>
                       <div class="form-group">
                           <button type="submit" class="btn btn-primary"  style="height:50px;width:110px;font-size:18pt;">Search</button>
                       </div>
                   </form>
                   <br>
                   <br>
